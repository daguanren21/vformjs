...
.nav-item {
  text-align: left; border: 1px solid #e4e7ed; background: #fff;
  border-radius: 8px; padding: 10px 12px; cursor: pointer;
}
.nav-item strong { display: block; margin-bottom: 4px; }
.nav-item span { color: #909399; font-size: 12px; }
.nav-item.active { border-color: #409eff; box-shadow: 0 0 0 1px #409eff inset; }
.main {
